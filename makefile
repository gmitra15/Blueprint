...
OBJ = core/main.o core/engine.o core/Wren++.o core/sprite.o core/sound.o core/input.o core/view.o core/random.o \
	  core/loaders/textureLoader.o core/loaders/soundLoader.o core/circle.o \
